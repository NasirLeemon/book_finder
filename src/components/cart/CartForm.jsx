...
const CartForm = () => {
  return (
    <div>
         <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-medium text-white">Name</label>
      ...
      <label htmlFor="email" className="mt-4 mb-2 block text-sm font-medium text-white">Email</label>
            ...
            <label htmlFor="billing-address" className="mt-4 mb-2 block text-sm font-medium text-white">Billing Address</label>
